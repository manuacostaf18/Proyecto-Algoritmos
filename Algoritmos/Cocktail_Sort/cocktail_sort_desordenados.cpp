...
int main(){
  ...
  double t1_0 = gettime();
	CocktailSort(vector1_desordenado, n1);
	double t1_1 = gettime();
	double t1 = t1_1 - t1_0;
  ...
  int n2 = vector2_desordenado.getsize();
	double t2_0 = gettime();
	CocktailSort(vector2_desordenado, n2);
	double t2_1 = gettime();
	double t2 = t2_1 - t2_0;
  ...
  int n3 = vector3_desordenado.getsize();
	double t3_0 = gettime();
	CocktailSort(vector3_desordenado, n3);
	double t3_1 = gettime();
	double t3 = t3_1 - t3_0;
  ...
  int n4 = vector4_desordenado.getsize();
	double t4_0 = gettime();
	CocktailSort(vector4_desordenado, n4);
	double t4_1 = gettime();
	double t4 = t4_1 - t4_0;
  ...
  int n5 = vector5_desordenado.getsize();
	double t5_0 = gettime();
	CocktailSort(vector5_desordenado, n5);
	double t5_1 = gettime();
	double t5 = t5_1 - t5_0;
